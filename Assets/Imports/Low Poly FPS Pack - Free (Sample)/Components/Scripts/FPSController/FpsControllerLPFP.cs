...
#pragma warning restore 649
        ...
        public void ChangeArms(Transform newArms)
        {
            AssignCharactersCamera(newArms);
        }
        ...
        private void AssignCharactersCamera(Transform newArms = null)
        {
            var t = transform;
            if (newArms == null)
            {
            ...
            {
                Transform oldArm = arms;
                arms = newArms;
                arms.SetPositionAndRotation(t.position, Quaternion.Euler(oldArm.rotation.eulerAngles.x, t.rotation.eulerAngles.y, t.rotation.eulerAngles.z));
            }
        }
        ...
        private void MoveCharacter()
        {
            ...
            var velocity = worldDirection * ((input.Run && gm.PlayerObject.CanRun) ? runningSpeed : walkingSpeed);
